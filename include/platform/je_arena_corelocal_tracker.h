...
public:
    static void clientRegistered(ArenaMallocClient client);
     ...
     */
    static size_t getPreciseAllocated(ArenaMallocClient client);
     ...
     */
    static size_t getEstimatedAllocated(ArenaMallocClient client);
...
private:
    static void maybeUpdateEstimatedTotalMemUsed(
            uint8_t index,
