...
private:
     ...
     */
    static void memAllocated(const ArenaMallocClient& client, size_t size) {
        trackingImpl::memAllocated(client, size);
    }
     ...
     */
    static void memDeallocated(const ArenaMallocClient& client, void* ptr) {
        trackingImpl::memDeallocated(client, ptr);
    }

    static void threadUp(const ArenaMallocClient& client) {
        trackingImpl::threadUp(client);
    }
